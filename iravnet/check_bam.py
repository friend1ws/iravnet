...
def check_seqlen(input_bam, max_check_count = 1000):
    ...
    for read in bam_file.fetch():
        ...
        if read.query_length not in seqlen2count: seqlen2count[read.query_length] = 0
        seqlen2count[read.query_length] = seqlen2count[read.query_length] + 1
        
        check_count = check_count + 1

        if check_count >= 1000: break
